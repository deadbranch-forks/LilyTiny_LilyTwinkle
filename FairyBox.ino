...
////// OLED STUFF
    ...
    // if ((celebrate != lastCelebrateState) || (fastMode != lastCoffeeState) || (lastpin1FadeCycleCompletionCount != pin1FadeCycleCompletionCount) || (lastfastModeCycleCountTrigger != fastModeCycleCountTrigger) || (lastcelebrationRoll != celebrationRoll)) {
    //   oled.clear();
    //   oled.print("Coffee: ");
    //   oled.print(pin1FadeCycleCompletionCount);
    //   oled.print("/");
    //   oled.print(fastModeCycleCountTrigger);
    //   oled.println("Celebration: ");
    //   oled.print(celebrationRoll);
    //   oled.print("/25 | ");
    //   oled.print("Celebrating: ");
    //   oled.print(celebrate);
    //   oled.println("Waiting to celebrate: ");
    //   oled.print(waitingToCelebrate); 
    //   lastCelebrateState = celebrate;
    //   lastCoffeeState = fastMode;
    //   lastpin1FadeCycleCompletionCount = pin1FadeCycleCompletionCount;
    //   lastfastModeCycleCountTrigger = fastModeCycleCountTrigger;
    //   lastcelebrationRoll = celebrationRoll;
    //   //print(" | Peak: ")
    }
